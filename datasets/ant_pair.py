...
class AntDetection(torchvision.datasets.CocoDetection):
    def __init__(self, img_folder, ann_file, test_img_folder, return_masks, image_set):
...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "test": (root / "val", root / 'ground-truth-test.json')
    }

    img_folder, ann_file = PATHS[image_set]
    test_img_folder, _ = PATHS["test"]
    dataset = AntDetection(img_folder, ann_file, test_img_folder, return_masks=args.masks, image_set=image_set)
    return dataset
